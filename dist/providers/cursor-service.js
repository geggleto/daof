 ...
 */
export function createCursorProviderService(apiKey) {
    return {
        async complete(prompt, options) {
            ...
            if (!key) {
                return {
                    ok: false,
                    error: "Cursor provider has no API key. Set CURSOR_API_KEY in .env or .env.local (in the directory where you run daof) or export it.",
                };
            }
